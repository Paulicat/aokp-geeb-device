...
PRODUCT_COPY_FILES += \
             device/lge/geeb/scripts/init.gee.bt.sh:system/etc/init.gee.bt.sh \
	device/lge/geeb/scripts/efsbackup.sh:system/bin/efsbackup.sh
...
# Advanced Reboot
PRODUCT_COPY_FILES += \
             device/lge/geeb/kerneltweaks:system/etc/init.d/kerneltweaks
